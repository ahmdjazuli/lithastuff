...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2021 at 03:50 AM
...
(37, 4, 12, '2021-11-01', 13000, '1833IMG.20211022.WA0026.jpg', 'Menunggu', 'COD', 0, 'Jl. Bunga Melati kota Banjarbaru'),
(38, 7, 12, '2021-11-02', 146000, '5219IMG.20210830.WA0010.jpg', 'Diterima', 'COD', 0, 'MTP'),
(39, 3, 12, '2021-11-06', 133000, '2265IMG.20210815.WA0023.jpg', 'Menunggu', 'COD', 0, 'Gang Hijrah Raya, Muhibbin 4 Sekumpul'),
...
(30, 38, 12, 1, 'Chemira Bergo Sport', 13000, 13000),
(31, 38, 10, 2, 'Kemeja Flanel Crop', 85000, 170000),
(32, 39, 7, 1, 'Highwaist Loose Kulot', 63000, 63000),
(33, 39, 13, 1, 'Kemeja Flanel Korea', 70000, 70000),
...
(5, 'Kemeja Saku Rempel 1029', 'Kemeja', 55000, 73000, 'Bahan : Rayon Premium dan Lingkar Dada 120cm', '3438Screenshot.20211101.060042.Instagram..2..jpg', 4, 65000, 0, 0),
(6, 'Kemeja Flanel Crop Premium', 'Kemeja', 60000, 85000, 'Bahan : Flanel Tebal dan Lembut, Lingkar Dada 120cm, Panjang 70cm.', '9085Screenshot.20211101.060058.Instagram..2..jpg', 3, 70000, 0, 0),
...
(8, 'Crincle Blouse', 'Kemeja', 35000, 50000, 'Bahan Katun Rayon Diamond, Lingkar Dada 122cm, Panjang Baju 56cm dan Panjang Lengan 54cm.', '7740Screenshot.20211101.060533.Instagram..2..jpg', 0, 40000, 0, 0),
(9, 'Highwaist Loose Kulot 1024', 'Kemeja', 52000, 63000, 'Bahan : Linen, Ukuran S-M-L, Lingkar Paha 73cm, Lingkar Pinggang 74-100cm dan Panjang 95cm.', '6256Screenshot.20211101.060455.Instagram..3..jpg', 0, 57000, 0, 0),
...
(12, 'Chemira Bergo Sport', 'Jilbab', 6000, 13000, 'Bahan Jersey.', '8746Screenshot.20211101.060737.Instagram..2..jpg', 3, 8000, 2, 0),
...
--
ALTER TABLE `beli`
  MODIFY `idbeli` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `beliproduk`
--
ALTER TABLE `beliproduk`
  MODIFY `idbeliproduk` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `flashsale`
--
ALTER TABLE `flashsale`
  MODIFY `idflash` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tanam`
  MODIFY `idtanam` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `tanammasuk`
--
ALTER TABLE `tanammasuk`
  MODIFY `idtanammasuk` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
