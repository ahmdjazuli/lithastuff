          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button style="float: right;margin-left: 5px" class="btn btn-success" type="button" data-toggle="tooltip" data-placement="bottom" title="Tambah"><a href="kurir_input.php" class="text-white"><i class="fas fa-folder-plus"></i></a></button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                      ...
                      while($data = mysqli_fetch_array($query)){
                        ?>
                          ...
                          <td>
                            ...
                            <button class="btn bg-orange" onclick="yakin = confirm('Apakah Kamu yakin ingin Menghapus?'); if(yakin){ window.location = 'hapus.php?idkurir=<?= $data['idkurir'] ?>';
