          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h2 style="display:inline;">Data Pembelian Konsumen</h2>
              ...
              <div class="card-body">
                <table id="dataTables" class="table table-bordered table-sm">
                  ...
                  <tbody>
                    <?php 
                      $no = 1;
                      $query = mysqli_query($kon, "SELECT * FROM `beli` INNER JOIN ongkir ON beli.idongkir = ongkir.idongkir INNER JOIN user ON beli.id = user.id");
                      while($data = mysqli_fetch_array($query)){
                        ?>
                          ...
                          <td>
                            ...
                            <button class="btn bg-orange" onclick="yakin = confirm('Apakah Kamu yakin ingin Menghapus?'); if(yakin){ window.location = 'hapus.php?idbeli=<?= $data['idbeli'] ?>';
