                    ...
                    <?php 
                      ...
                      while($data = mysqli_fetch_array($query)){
                        ?>
                          ...
                          <td><?= $data['level'] ?></td>
                          <td>
                            <button class="btn bg-warning" type="button"><a href="user_edit.php?id=<?= $data['id'] ?>" class="text-white"><i class="far fa-edit"></i></a></button>
                            <button class="btn bg-orange" onclick="yakin = confirm('Apakah Kamu yakin ingin Menghapus?'); if(yakin){ window.location = 'hapus.php?id=<?= $data['id'] ?>';
