          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h2 style="display:inline;">Data Barang Masuk</h2>
                <button style="float: right;margin-left: 5px" class="btn btn-success" type="button" data-toggle="tooltip" data-placement="bottom" title="Tambah"><a href="tanammasuk_input.php" class="text-white"><i class="fas fa-folder-plus"></i></a>
                </button>
                    ...
                    <?php 
                      ...
                      while($data = mysqli_fetch_array($query)){
                        ?>
                          ...
                          <td><?= $data['catatan'] ?></td>
                          <td>
                            <button class="btn bg-warning" type="button"><a href="tanammasuk_edit.php?idtanammasuk=<?= $data['idtanammasuk'] ?>" class="text-white"><i class="far fa-edit"></i></a></button>
                            <button class="btn bg-orange" onclick="yakin = confirm('Apakah Kamu yakin ingin Menghapus?'); if(yakin){ window.location = 'hapus.php?idtanammasuk=<?= $data['idtanammasuk'] ?>';
