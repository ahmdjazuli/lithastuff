<?php require('headernya.php'); error_reporting(0);  ?>
  ...
  <div class="content-wrapper"><br>
    <section class="content">
      <div class="container"><h2 class="text-center"><button class="btn btn-default" type="button" data-toggle="tooltip" data-placement="bottom" title="Tambah"><i class="fas fa-folder-plus"></i></button> Tambah Pembelian Reseller</h2>
        <div class="row">
          <div class="col-md-4">
                    ...
                    <?php
                      ...
                      $a    = "var harga_r = new Array();\n;";
                        while($baris = mysqli_fetch_array($ahay)) {
                          ...
                          $a .= "harga_r['" . $baris['idtanam'] . "'] = {harga_r:'" . addslashes($baris['harga_r'])."'};\n";
                        } 
                      ?>
                  </select>
                  </div>
                ...
                <form role="form" action="" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <select name="id" class="form-control" required>
                        <option value="">-Pilih-</option>
                      <?php
                        $gasken = mysqli_query($kon, "SELECT * FROM user WHERE level='reseller' ORDER BY nama ASC");
